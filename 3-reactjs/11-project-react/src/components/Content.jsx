      ...
      <div className="flex flex-col-reverse items-center justify-between pt-40 p-6 md:p-12 md:pt-40 lg:p-32 lg:pt-40 lg:flex-row text-left">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-branco mt-4 lg:mt-6 text-sm md:text-base lg:text-xl 2xl:text-2xl">
            Hermina, uma jovem obscurecida pela monotonia de sua vida, tem sua
            existência transformada ao se deparar com um encontro
            extraordinário.
            {/* Descrição introdutória sobre o livro. */}
            <br />
            <br />
            Ambientado na Hungria, nas vésperas da Primeira Guerra, Mina se vê
            diante de um dilema que irá desencadear uma reação em cadeia
            irreversível.
            {/* História e contexto do livro. */}
          </p>

          <button className="text-branco mt-4 lg:mt-6" onClick={openModal}>
